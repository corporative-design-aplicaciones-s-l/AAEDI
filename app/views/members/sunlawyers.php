                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-8 wow fadeInUp" data-wow-delay=".2s">
                        <div class="text-center">
                            <img src="img/members/sunlawyers.png" alt="Sun Lawyers" class="img-responsive mb-4"
                                width="55%">
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="text-center">
                            <p><i class="fa fa-envelope"></i> <a
                                    href="mailto:admin@sun-lawyers.com">admin@sun-lawyers.com</a></p>
                        </div>
                    </div>
                </div>

                <form action="php/contact.php" class="ajax-form form-main">
                    <input type="hidden" name="member_name" value="Sun Lawyers">
                    <input type="hidden" name="member_email" value="admin@sun-lawyers.com">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="custom-select">
                                ...
                                <select name="Subject">
                                    ...
                                    <option>Compra/Venta de Propiedad</option>
                                    <option>Fiscalidad o NIE</option>
                                    <option>Herencias / Testamentos</option>
                                    <option>Visas y reubicación</option>
