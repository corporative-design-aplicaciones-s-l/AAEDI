...
$bg = '#f6f7fb';
$card = '#ffffff';
$memberLabel = htmlspecialchars($member['name'] . ' (' . $member['slug'] . ')');
?>
<!doctype html>
<html lang="es">

<body
    style="margin:0;padding:0;background:<?= $bg ?>;font-family:Segoe UI,Roboto,Arial,sans-serif;line-height:1.5;color:<?= $text ?>;">
                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td style="padding:22px 24px 10px;">
                            <h2 style="margin:0 0 6px 0;">Nuevo contacto para <?= $memberLabel ?> — #<?= (int) $id ?>
                            </h2>
                    ...
                    <tr>
                        <td style="padding:8px 24px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <?php $row = function ($l, $v) use ($muted, $text) { ?>
                                    <tr>
                                        <td
                    ...
                    <tr>
                        <td style="padding:18px 24px 22px;">
                            <a href="mailto:<?= htmlspecialchars($email) ?>?subject=Respuesta%20<?= rawurlencode($member['name']) ?>%20%23<?= (int) $id ?>"
                                style="display:inline-block;background:#0b5ab8;color:#fff;text-decoration:none;font-weight:600;border-radius:8px;padding:10px 16px;">
                                Responder
                            </a>
